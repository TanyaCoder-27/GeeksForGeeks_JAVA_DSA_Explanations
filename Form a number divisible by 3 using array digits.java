...
Difficulty: EasyAccuracy: 63.96%Submissions: 78K+Points: 2
...
class Solution {
    static int isPossible(int N, int arr[]) {
        int s=0;
        //dont get confused because of strings in the question, its just the same logic we know about divisibility of 3: sum of digits shuld get divisible by 3!
        for(int i:arr){
        while(i!=0){
            int r = i%10;
            s+=r;
